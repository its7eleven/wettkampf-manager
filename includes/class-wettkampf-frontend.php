<?php
/**
 * Frontend functionality for Wettkampf Manager with Categories
 */
...
class WettkampfFrontend {
                        ...
                        <div class="wettkampf-details" id="details-<?php echo $wettkampf->id; ?>" style="display: none;">
                            <div class="wettkampf-info">
                                ...
                                $wettkampf_disziplinen = $wpdb->get_results($wpdb->prepare("
                                    ...
                                    ORDER BY d.kategorie ASC, d.sortierung ASC, d.name ASC
                                ", $wettkampf->id));
                                
                                if (!empty($wettkampf_disziplinen)): 
                                    // Gruppiere Disziplinen nach Kategorien
                                    $grouped_disziplinen = array();
                                    foreach ($wettkampf_disziplinen as $disziplin) {
                                ...
                                <div class="info-row">
                                    ...
                                    <div style="margin-top: 12px;">
                                        <?php 
                                        // Sortiere Kategorien für bessere Anzeige
                                        $kategorie_order = array('U10', 'U12', 'U14', 'U16', 'U18', 'Alle');
                                        uksort($grouped_disziplinen, function($a, $b) use ($kategorie_order) {
                                            $pos_a = array_search($a, $kategorie_order);
                                            $pos_b = array_search($b, $kategorie_order);
                                            if ($pos_a === false) $pos_a = 999;
                                            if ($pos_b === false) $pos_b = 999;
                                            return $pos_a - $pos_b;
                                        });
                                        
                                        foreach ($grouped_disziplinen as $kategorie => $disziplinen): ?>
                                                ...
                                                <div style="margin-left: 8px;">
                                                    <?php foreach ($disziplinen as $disziplin): ?>
                                                        <div style="margin-bottom: 4px;">
                                                            <span style="color: #111827; font-weight: 500;">• <?php echo esc_html($disziplin->name); ?></span>
                                                            <?php if ($disziplin->beschreibung): ?>
                                                                <small style="color: #6b7280; margin-left: 8px;">(<?php echo esc_html($disziplin->beschreibung); ?>)</small>
                                                            <?php endif; ?>
                                                        </div>
                                                    <?php endforeach; ?>
                                                </div>
                                    ...
                                    ?>
                                        <div class="teilnehmer-item">
                                            <div class="teilnehmer-info">
                                                ...
                                                <button class="show-disziplinen-button" data-anmeldung-id="<?php echo $anmeldung->id; ?>" title="Disziplinen anzeigen" style="background: none; border: none; color: #6b7280; font-size: 12px; cursor: pointer; margin-left: 8px;">📋</button>
                                            </div>
                                        ...
                                        <!-- Ausklappbare Disziplinen-Anzeige -->
                                        <div class="teilnehmer-disziplinen" id="disziplinen-<?php echo $anmeldung->id; ?>" style="display: none; margin-left: 20px; margin-top: 8px; padding: 8px 12px; background: #f8fafc; border-radius: 4px; border-left: 3px solid #e5e7eb;">
                                            <small style="color: #6b7280; font-weight: 500;">
                                                ...
                                                if (!empty($disziplin_names)) {
                                                    echo implode(', ', $disziplin_names);
                                                } else {
                                                    echo '<em>Keine Disziplinen ausgewählt</em>';
                                                }
                                                ?>
                                            </small>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <form id="anmeldung-form">
                    ...
                    <div class="form-group">
                        ...
                        <!-- VEREINFACHTE Kategorie-Anzeige -->
                    ...
                    <!-- Disziplinen werden dynamisch geladen - Position nach Jahrgang -->
            ...
            <div class="modal-content">
                ...
                <form id="mutation-edit-form" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <small style="color: #666; display: block; margin-top: 5px;">Bitte gib dein Geburtsjahr 4-stellig ein (z.B. 2010)</small>
                        <!-- VEREINFACHTE Kategorie-Anzeige für Edit -->
    ...
    // Erweiterte get_wettkampf_disziplinen Methode mit korrigierter Kategorie-Filterung
